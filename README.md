...
| Hub target-data sync | Friday 02:00 UTC / Sunday 06:00 UTC (Hub `sync-target-data.yaml`) |
| Dashboard data refresh | Friday 04:00 UTC / Sunday 08:00 UTC (automated, `regenerate=true`; after Hub sync) |
